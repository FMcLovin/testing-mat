...
describe('SimpsonComponent', () => {
  ...
  xit('Should return p=16.0 if x0=0, x1=4, num_seg=4, ERROR=0.0001 and f(x)=2x', () => {
    expect(component.simpson(0, 4, 4, 0.0001, (x) => 2 * x)).toBeCloseTo(16.0);
  });

  xit('Should return p=0.3333 if x0=0, x1=1, num_seg=4, ERROR=0.0001 and f(x)=x^2  ', () => {
    expect(component.simpson(0, 1, 4, 0.0001, (x) => x * x)).toBeCloseTo(0.333);
  });

  xit('Should return p=1.38 if x0=1, x1=4, num_seg=6, ERROR=0.001 and f(x)=1/x  ', () => {
